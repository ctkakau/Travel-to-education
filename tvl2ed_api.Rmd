...
# select the regional council codes
edu_regions <- paste(edu[(as.numeric(edu$code) <=19) & (nchar(edu$code) ==2),]$code, collapse = "+")
edu_ <- edu_regions # some regional breakdowns
# edu_ <- c("01+02+03+17+18")
...
# query data
tvl_to_ed <- ade_api_data_by_key(key, "CEN23_TRA_001", df_dims)
